...
public class InitializationFragment extends AbsTablesFragment
   ...
   public static final String PROGRESS_DIALOG_TAG = "progressTablesInitFrag";
   public static final String ALERT_DIALOG_TAG = "alertTablesInitFrag";
   ...
   @Override public void onPause() {
      ...
      // dismiss dialogs...
      DialogFragment alertDialog = (DialogFragment) mgr.findFragmentByTag(ALERT_DIALOG_TAG);
      if (alertDialog != null) {
         alertDialog.dismiss();
      }
      DialogFragment progressDialog = (DialogFragment) mgr.findFragmentByTag(PROGRESS_DIALOG_TAG);
    ...
    * the import
    */
   @Override public void cancelProgressDialog() {
