...
public class SurveyUtil {
   ...
   */
  private static final String URI_SURVEY_QUERY_PARAM_FORM_PATH = 
      "formPath";
  ...
  private static Uri getUriForSurveyHelper(TableProperties tp, 
    ...
    if (surveyFormParameters.getFormPath() != null) {
      uriStr += "&" + URI_SURVEY_QUERY_PARAM_FORM_PATH + 
          surveyFormParameters.getFormPath();
    }
  ...
  public static class SurveyFormParameters {
    ...
    /** TODO: comment this appropriately. */
