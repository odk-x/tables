...
public class SyncRow {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (this.getRowId() == null ? other.getRowId() != null : !this.getRowId().equals(
        (java.lang.Object) other.getRowId()))
      return false;
    if (this.getSyncTag() == null ? other.getSyncTag() != null : !this.getSyncTag().equals(
        (java.lang.Object) other.getSyncTag()))
      return false;
  ...
  public java.lang.String toString() {
    return "SyncRow(rowId=" + this.getRowId() + ", syncTag=" + this.getSyncTag() + ", deleted="
        + this.isDeleted() + ", values=" + this.getValues() + ")";
  }
}