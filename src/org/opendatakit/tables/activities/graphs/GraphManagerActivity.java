...
public class GraphManagerActivity extends SherlockListActivity {
	...
	private void init() {
	   ...
	   if ( appName == null ) {
		...
		this.kvsh =
				tp.getKeyValueStoreHelper(GraphDisplayActivity.KVS_PARTITION_VIEWS);
		this.graphViewKvsh =
				tp.getKeyValueStoreHelper(GraphDisplayActivity.KVS_PARTITION);
		this.defaultGraphViewName =
				graphViewKvsh.getString(GraphDisplayActivity.KEY_GRAPH_VIEW_NAME);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		String filenameOfSelectedView =
				aspectHelper.getString(GraphDisplayActivity.GRAPH_TYPE);
		...
		newGraphViewIntent.putExtra(GraphDisplayActivity.POTENTIAL_GRAPH_VIEW_NAME, getPotentialGraphName());
	...
	public boolean onContextItemSelected(android.view.MenuItem item) {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					if (entryName.equals(defaultGraphViewName)) {
						...
						generalViewHelper.removeKey(
						    GraphDisplayActivity.KEY_GRAPH_VIEW_NAME);
					}
		...
		case MENU_EDIT_ENTRY:
			...
			Intent editGraphViewIntent = new Intent(GraphManagerActivity.this,
					GraphDisplayActivity.class);
         editGraphViewIntent.putExtra(
             Controller.INTENT_KEY_APP_NAME, appName);
			editGraphViewIntent.putExtra(
			    Controller.INTENT_KEY_TABLE_ID, tableId);
			editGraphViewIntent.putExtra(
			    GraphDisplayActivity.KEY_GRAPH_VIEW_NAME, entryName);
			editGraphViewIntent.putExtra(GraphDisplayActivity.POTENTIAL_GRAPH_VIEW_NAME, getPotentialGraphName());
	...
	class GraphViewAdapter extends ArrayAdapter<String> {
		 ...
		 */
		GraphViewAdapter() {
			super(GraphManagerActivity.this,
