...
import org.opendatakit.hope.types.FormType;
...
public class EditFormDialogPreference extends DialogPreference {
  ...
  protected View onCreateDialogView() {
    ...
    LinearLayout view = (LinearLayout) inflater.inflate(
        org.opendatakit.hope.R.layout.edit_default_form_preference, null);
    this.mDefaultCheckBox = (CheckBox) view.findViewById(
        org.opendatakit.hope.R.id.edit_def_form_checkbox_use_default_form);
