...
import org.opendatakit.hope.sync.SynchronizationResult;
import org.opendatakit.hope.sync.Synchronizer;
import org.opendatakit.hope.sync.TableResult;
import org.opendatakit.hope.sync.TablesContentProvider;
...
import org.opendatakit.hope.sync.files.FileSyncAdapter;
    ...
    if (accountName == null) {
      ...
      for (Account account : accounts) {
        if (account.name.equals(accountName)) {
          ...
          ContentResolver.setIsSyncable(account, "org.opendatakit.hope.tablefilesauthority", 1);
          ContentResolver.setSyncAutomatically(account, "org.opendatakit.hope.tablefilesauthority", true);
          ContentResolver.requestSync(account,
              "org.opendatakit.hope.tablefilesauthority", extras);
        }
      }
