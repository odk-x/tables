 ...
 * the License.
 */
package org.opendatakit.hope.sync.aggregate;
...
import org.opendatakit.hope.sync.IncomingModification;
import org.opendatakit.hope.sync.Modification;
import org.opendatakit.hope.sync.SyncRow;
...
public class AggregateSynchronizer implements Synchronizer {
  ...
  /*
   * (non-Javadoc)
   * @see org.opendatakit.hope.sync.Synchronizer#createTable(j
  ...
  /*
   * (non-Javadoc)
   * @see org.opendatakit.hope.sync.Synchronizer#setTableProperties(
