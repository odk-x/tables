 ...
 * the License.
 */
package org.opendatakit.hope.sync.files;
...
//        desiredKeys.add(TableProperties.KEY_DETAIL_VIEW_FILE);
        ...
        ContentResolver.setIsSyncable(account, "org.opendatakit.hope.tablefilesauthority", 0);
        ContentResolver.setSyncAutomatically(account, "org.opendatakit.hope.tablefilesauthority", false);
      }
    }
