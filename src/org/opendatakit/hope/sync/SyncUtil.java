...
public class SyncUtil {
  ...
  public static org.opendatakit.hope.data.TableType transformServerTableType(
      org.opendatakit.aggregate.odktables.rest.entity.TableType serverType) {
    org.opendatakit.hope.data.TableType phoneType =
        org.opendatakit.hope.data.TableType.data;
    switch (serverType) {
    case DATA:
      phoneType = org.opendatakit.hope.data.TableType.data;
      break;
    case SHORTCUT:
      phoneType = org.opendatakit.hope.data.TableType.shortcut;
      break;
    case SECURITY:
      phoneType = org.opendatakit.hope.data.TableType.security;
      break;
    default:
  ...
  transformClientTableType(org.opendatakit.hope.data.TableType clientType) {
    org.opendatakit.aggregate.odktables.rest.entity.TableType serverType =
