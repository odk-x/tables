...
public class TableProperties {
	...
	public void setPrimeColumns(String[] primeColumns) {
		...
		setStringProperty(DB_PRIME_COLUMNS, str.substring(0, str.length() - 1));
		this.primeColumns = primeColumns;
	}
	 ...
	 * 
	 * @param tableId
	 *            the ID of the new read security table (or -1 to set no read
	 *            security table)
	 */
	 ...
	 * 
	 * @param tableId
	 *            the ID of the new write security table (or -1 to set no write
	 *            security table)
	 */
